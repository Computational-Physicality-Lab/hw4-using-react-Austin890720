...
const Detail = () => {
    ...
    const [shirtColor, setShirtColor] = useState(localStorage.getItem('shirt_color') || 'white');
    ...
    const handleClick = () => {
        if (selectedSize !== "Size") {
            const newItem = { Price: price, Name: name, Quantity: quantity, SelectedSize: selectedSize, ShirtColor: shirtColor, ShirtNumber: shirtNumber };
            let items;
        ...
        <Container className='Detail'>
            ...
            <div className='shirt_details'>
                ...
                <div className='detail_element_right'>
                    ...
                    <button className='side_button' onClick={() => handleSideButtonClick('front')}>
                        Front
                    </button>
                    <button className='side_button' onClick={() => handleSideButtonClick('back')}>
                        Back
                    </button>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center' }}>
                        ...
                        <div className='quantity'>
                            <select value={quantity} onChange={handleChange} className='quantity_size'>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center' }}>
                        ...
                        <div className='Size'>
                            <select value={selectedSize} onChange={handleSizeChange} className='size_size'>
                    ...
                    {selectedSize === "Size" || price === undefined ? (
                        <button className="addToCart disabled disabled-button">Add To Cart</button>
                    ) : (
